...
6. Opcional: substitua os diretórios locais do logo e arquivo .css (exemplo: https://github.com/cnpem-emi/Doxygen/blob/master/doxygen-awesome.css), caso deseje maior personalização (encontre no doxyfile.txt: PROJECT_LOGO e HTML_STYLESHEET).
